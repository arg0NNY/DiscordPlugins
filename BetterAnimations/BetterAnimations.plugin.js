...
const Routes = [
  new Route('Chat', [
    '/channels/:guildId(@me|@favorites|@guilds-empty-nux|@inbox|\\d+)/:channelId(role-subscriptions|server-monetization-onboarding|shop|member-applications|@home|channel-browser|onboarding|customize-community|member-safety|boosts|report-to-mod|\\d+)/threads/:threadId/:messageId?',
    ...
    '/channels/:guildId(@me|@favorites|@guilds-empty-nux|@inbox|\\d+)/:channelId(role-subscriptions|server-monetization-onboarding|shop|member-applications|@home|channel-browser|onboarding|customize-community|member-safety|boosts|report-to-mod|\\d+)?/:messageId?'
  ], {
              ...
              React.createElement(
                ...
                [
                  ...
                  React.createElement(
                    Text,
                    {
                      className: Selectors.Sticker.stickerName,
